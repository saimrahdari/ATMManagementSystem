 ...
 * @author Saim
 */
public class CustomerAccountReportDetails extends javax.swing.JFrame {

    /**
     * Creates new form CustomerAccountReportDetails
     */
    ...
    public CustomerAccountReportDetails() {
        initComponents();
        f = new JFrame();
    }
    
    public CustomerAccountReportDetails(int customerId, int accountNumber, String description) {
        initComponents();
        f = new JFrame();
        this.customerId = customerId;
        this.accountNumber = accountNumber;
        this.description = description;
        getData(customerId, accountNumber, description);
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("Last Transaction Time");

        jLabel7.setFont(new java.awt.Font("Constantia", 1, 18)); // NOI18N
        jLabel7.setForeground(new java.awt.Color(255, 255, 255));
        jLabel7.setText("Number of  Transactions");
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(28, 28, 28)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(jTextField7, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.PREFERRED_SIZE, 321, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CustomerAccountReportDetails.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void getData(int customerId, int accountNumber, String description) {
        ...
        ResultSet r1 = Connect.get_result("Select max(report_id) from account_reports");
        ...
        ResultSet r2 = Connect.get_result("select account.account_balance from account join account_reports on account_reports.customer_c_id = " + customerId + " where account.account_number = " + accountNumber); 
        ...
        ResultSet r3 = Connect.get_result("select max(transaction.transaction_id) from transaction where transaction.customer_c_id = " + customerId); 

        try{
            while(r3.next()){
                max_transaction_id = r3.getInt(1);
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        ...
        ResultSet r4 = Connect.get_result("select transaction.transaction_time from transaction where transaction_id = " + max_transaction_id); 

        try{
            while(r4.next()){
                last_transaction_time = r4.getString(1);
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        ...
        ResultSet r5 = Connect.get_result("select count(*) from transaction where transaction.customer_c_id = " + customerId); 

        try{
            while(r5.next()){
                number_of_transactions = r5.getInt(1);
            }
        } catch (Exception e) {
            System.out.println(e.toString());
        ...
        jTextField9.setText(Integer.toString(balance));
        jTextField6.setText(last_transaction_time);
        jTextField7.setText(Integer.toString(number_of_transactions));
        jTextField8.setText(description);
        
        //System.out.println(i);
        //System.out.println(balance);
       // System.out.println(last_transaction_time);
        ...
        try{
            ...
            PreparedStatement prepareStatement = mycon.prepareStatement("INSERT INTO account_reports(REPORT_ID, TOTAL_BALANCE, CUSTOMER_C_ID, DESCRIPTION)" + " VALUES (?, ?, ?, ?)");
            prepareStatement.setInt(1, i);
            prepareStatement.setInt(2, balance);
