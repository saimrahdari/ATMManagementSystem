 ...
 * @author Saim
 */
public class AdminUpdateCustomerProfile extends javax.swing.JFrame {
    ...
    int customerId;
    JFrame f;
    public AdminUpdateCustomerProfile() {
        f = new JFrame();
        initComponents();
    }
    
    public AdminUpdateCustomerProfile(int customerId) {
        f = new JFrame();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUpdateCustomerProfile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminUpdateCustomerProfile().setVisible(true);
            }
        });
    }
