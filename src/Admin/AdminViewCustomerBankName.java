 ...
 * @author Saim
 */
public class AdminViewCustomerBankName extends javax.swing.JFrame {

    /**
     * Creates new form AdminViewCustomerBankName
     */
    public AdminViewCustomerBankName() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id", "Name", "Email", "Phone Number", "Region", "Bank Name"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminViewCustomerBankName.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
    ...
    public void getData(String query){
        ...
        try{
            while(results.next() ){
                ...
                ResultSet r = Connect.get_result("select bank.bank_name from bank join inserted_into on bank.atm_atm_id = inserted_into.atm_atm_id where inserted_into.card_card_no = (select card_no from card where card.customer_c_id = " + results.getInt(2) + ")");
                
                if(r.next()){
                    Object[] row = { results.getInt(2), results.getString(1),results.getString(7) , results.getInt(4), results.getString(8), r.getString(1)};
                    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                    model.addRow(row);
                } else {
                    Object[] row = { results.getInt(2), results.getString(1),results.getString(7) , results.getInt(4), results.getString(8), "N/A"};
                    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                    model.addRow(row);
                }   
            }
