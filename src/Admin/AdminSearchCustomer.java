 ...
 * @author Saim
 */
public class AdminSearchCustomer extends javax.swing.JFrame {

    /**
     * Creates new form AdminSearchCustomer
     */
    ...
    private void initComponents() {
        ...
        jLabel7.setText("Enter Cutomer Id");
        ...
        jTextArea1.setBackground(new java.awt.Color(22, 28, 33));
...
// TODO add your handling code here:
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        try{
            ...
            if((results.getInt(2) == Integer.valueOf(jTextField1.getText()))){
                jTextArea1.setText(results.getInt(2) + "\t" + results.getString(1) + "\t" + results.getString(3) + "\t" + results.getInt(4) + "\t" + results.getString(7) + "\t" + results.getString(8));
                found = true;
            }
        }
        } catch(Exception e) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminSearchCustomer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
