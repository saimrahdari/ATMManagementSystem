...
public class AdminFeedback extends javax.swing.JFrame {
    ...
    /**
     * Creates new form AdminFeedbacks
     */
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Number", "Title", "Description", "Customer Name"
            }
        ) {
        ...
        jButton9.setText("View Customer's Feedback");
...
// TODO add your handling code here:
    ...
    public void getData(){
        ResultSet results = Connect.get_result("Select * from feedback order by feedback_number");
        try{
            while(results.next() ){
                ResultSet r = Connect.get_result("select customer.c_name from customer where customer.c_id in (select submits.customer_c_id from submits join feedback on submits.feedback_feedback_number =  "+ results.getInt(1) +")");
                
                if(r.next()){
                    Object[] row = { results.getInt(1), results.getString(2),results.getString(3), r.getString(1)};
                    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                    model.addRow(row);
                } else {
                    Object[] row = { results.getInt(1), results.getString(2),results.getString(3), "No Customer"};
                    DefaultTableModel model = (DefaultTableModel) jTable1.getModel();
                    model.addRow(row);
                }
            }
