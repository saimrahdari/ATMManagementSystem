 ...
 * @author Saim
 */
public class AdminUpdateAtm1 extends javax.swing.JFrame {

    /**
     * Creates new form AdminUpdateAtm
     */
    
    JFrame f;
    public AdminUpdateAtm1() {
        initComponents();
        f = new JFrame();
    }
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int selected = Integer.valueOf(jTextField1.getText());
        boolean found = false;
        
        ResultSet results = Connect.get_result("Select * from ATM WHERE ATM.ATM_ID = " + selected);
        
        try{
            if(results.next()){
                found = true;
                //String select = results.getInt(3) + "\t" + results.getString(1)+ "\t" + results.getString(2)+ "\t" + results.getString(4)+ "\t" + results.getString(5);
        ...
        if (found){
            dispose();
            new AdminUpdateAtm2(selected).setVisible(true);
        } else {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminUpdateAtm1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
